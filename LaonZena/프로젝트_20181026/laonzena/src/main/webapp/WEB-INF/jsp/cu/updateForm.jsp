...
<body>
     ...
     <div class="wrap">
                ...
                <thead>
                    <tr>
                        ...
                        <td class="title" colspan="7">
                            <input type="text" name="title" value='${글제목}'>
                        </td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                        ...
                        <th>조회수</th>
                        <td class="cnt">
                            <input type="text" name="cnt" value='${조회수}'>
                        </td>
                        <th>추천수</th>
        ...
        <div id=comment>
                <input type="hidden" name="boardNo" value="${글번호}" />            
                <input id="cmtId" type="text" name="writerId" readonly="readonly" value="${댓글작성자아이디}"/>
